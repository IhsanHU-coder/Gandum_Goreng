...
class HomePageWidescreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Products Widescreen', style: AppTextStyle.headingMedium),
            ...
            child: Obx(() {
              ...
              return GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProductCard(
                    product: product,
                    onBuy: () => paymentController.payProduct(product),
                    onEdit: () {
      ...
      AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Center(child: productImagePicker(controller)),
